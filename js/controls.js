	...
	$.ajax({
		...
		success: function (response) {
			if (response) {
				...
				{
					let data=response[i];
					grouplistdata+=`<li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
						            	${data.GroupName}
						            	<span class="badge badge-primary badge-pill mr-0">12</span>
